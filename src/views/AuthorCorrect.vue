<template>
  <div>
    ...
    <div>
      <el-container>
        <el-avatar :size="50" :src="squareUrl" style="margin:10px 20px 10px 10px"></el-avatar>
      ...
      <el-container>
        ...
        <el-footer>
          ...
          <el-button type="success" @click="">Submit&nbsp;<i class="el-icon-star-off" ></i></el-button>
          <el-button type="danger" @click="">Delete&nbsp;<i class="el-icon-star-off" ></i></el-button>
        </el-footer>
      </el-container>
          ...
          <el-container>
            ...
            <el-container>
              ...
              <el-main>
                ...
                <p>Author:{{paperDetail.author_one}}&nbsp;&nbsp;{{paperDetail.author_two}}&nbsp;&nbsp;{{paperDetail.author_three}}</p>
                <p>{{paperDetail.author_one_institute}}</p>
                <p class="mainText">{{ paperDetail.pabstract }}</p>

                <p class="mainText"><strong>Abstract:&nbsp;{{ paperDetail.pkey }}</strong></p>
                <p class="mainText">Category:&nbsp;{{ paperDetail.category }}</p>
                <p class="mainText">Public ID:&nbsp;{{ paperDetail.public_id }}</p>
...
export default {
    ...
    data(){
        return {
           ...
           paperDetail:{
             ...
             pkey:"航空相机减振系统设计方法;振动耦合特性;角振动主动补偿;快速反射镜;角振动发生装置;",
             ...
             author_two:"林蕴奇",
             author_three:"阎之泓",
             author_one_institute:"中国科学院大学(中国科学院长春光学精密机械与物理研究所)",
  ...
  methods:{
    ...
    onPreveiw() {
      this.online_preview_msg = this.online_preview === true? "Preview ON ":"Preview OFF ";
    ...
    created(){
      ...
      const _this = this
    this.$axios.get("/author/paperEdit", {pap_id:pap_id,rev_id:rev_id}).then((res) => {
        console.log("=====")
        console.log(res)
        console.log("=====")
