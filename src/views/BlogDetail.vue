...
<!--            论文主体部分-->
            ...
            <p class="mainText"><strong>Abstract:&nbsp;{{ paper.pkey }}</strong></p>
    ...
    <transition name="el-zoom-in-top">
      <div v-show="online_preview" class="transition-box">
        ...
        <el-link icon="el-icon-edit" v-if="ownBlog">
          <router-link :to="{name: 'BlogEdit', params: {blogId: paper.id}}" >
            编辑
          </router-link>
        </el-link>
        <el-divider></el-divider>
        <div class="markdown-body" v-html="paper.content"></div>
      </div>
    </transition>
